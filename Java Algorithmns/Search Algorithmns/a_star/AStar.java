...
//This Program takes in a ASCII map and uses the A* algorithm to find the
//shortest route to the goal to be displayed via a grid of buttons,
//the heuristic function in determing which path to expand is
// Euclidean distance
public class AStar
{
