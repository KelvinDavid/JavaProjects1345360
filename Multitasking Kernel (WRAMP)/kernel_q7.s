...
#Question 07 - Priortise Gaming
#==========================================
#The function of this program is to modify 
#the kernel so that it would run smoother
#with the three tasks giving more time 
#to gaming task than the parallel or serial
