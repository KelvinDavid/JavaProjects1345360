...
#Question 05 - Multitasking with two tasks
#==========================================
#The function of this program is to be able
#two tasks simultaneously the parallel and
#serial at the same time given their time slice
...
timeSlice:
	addui	$13, $0, 100		#set timeslice to 100 ticks (1sec)
